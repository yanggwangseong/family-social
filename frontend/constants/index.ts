...
export const NOT_FOUND_GROUP_MESSAGE = '해당 그룹을 찾을 수 없습니다.';
...
export const NOT_FOUND_GROUP_EVENT = '그룹 이벤트가 없습니다.';
export const NOT_FOUND_GROUP_REQUEST = '그룹 초대 요청이 없습니다.';
